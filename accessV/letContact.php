  ...
  <div id="hero" class="container">
      ...
      <hr>
          ...
          <label for="exampleFormControlInput1" class="form-label">
              Name</label>&emsp;<a id="delX" class="btn" >X</a>    
          <input disabled id="txtNam" class="form-control" 
          ...
          aria-label=".form-control example"  onkeypress="return noCharTxt(event);" onkeydown="return noCharTxt(event);"  minlength="3" maxlength="20"  required/>
              ...
              <label for="exampleFormControlInput1" class="form-label">
              Email </label>&emsp;<a id="delX" class="btn" >X</a>   
          <input disabled id="txtMail" class="form-control" 
