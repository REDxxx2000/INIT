...
<img id="backG" />
  ...
  <section  class="hero-section">
    <div id="hero" class="container">
      ...
      <h2>INIT</h2>
      <!--<a href="app.html" class="btn">Check it out</a>-->
      <p><h6>Founded by a team of visionary architects, dev-engineers, and builders, we specialize in combining cutting-edge software with state-of-the-art construction practices to deliver innovative, efficient, and sustainable solutions.</p>
      </h6><hr><p>APPROACH<br>
        <h6>At INIT, we understand that every construction project is unique. That’s why we take a personalized approach, collaborating closely with clients to understand their specific needs and challenges. Our multidisciplinary team uses the latest technology and methodologies to develop innovative solutions that deliver measurable results, ensuring every project is completed on time, on budget, and with the highest quality standards.</p>
      </h6><hr><p>DIVISIONS<br>
        <h6>Custom Software Development<br>&emsp;Our team builds tailored software solutions that streamline construction operations, improve workflow efficiency, and enhance collaboration.<br>
        Device Management Tools <br>&emsp;With our advanced project management platforms, clients can oversee every aspect of their construction projects—from budgeting and scheduling to real-time tracking of progress and resources.<br>
        Smart Building Systems<br>&emsp;We design intelligent infrastructure that enhances energy efficiency, security, and overall building performance.<br>
   Construction Consulting: We provide expert advice to construction companies looking to implement new technologies that improve safety, reduce costs, and increase overall productivity.<br>
    </h6></p>
    </div>
