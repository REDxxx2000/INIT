        ...
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <a href="nem.php">
                <img id="imgCar" src="/images/mine1.jpg"  alt="..."
                style="
                width: AUTO;
                height: 360px;
                border-radius: 4px;
              ...
              <div class="carousel-item ">
                <a href="cleen.php">
                <img id="imgCar" src="/images/cleen6.jpg"  alt="..."
                style="
                width: AUTO;
                height: 360px;
                border-radius: 4px;
                ...
                <div class="carousel-caption ">
                  ...
                  width: 100%;
                  overflow:hidden;
                  ">Optimize your device</p>
                </div>
                </a>
              </div>
              <div class="carousel-item ">
                <a href="ecur.php">
                <img id="imgCar" src="/images/ecur3.jpg"  alt="..."
                style="
                width: AUTO;
                height: 360px;
                border-radius: 4px;
                ...
                <div class="carousel-caption ">
                  ...
                  width: 100%;
                  overflow:hidden;
                  ">Protection in & offline</p>
                </div>
                </a>
              </div>
              <div class="carousel-item ">
                <a href="normac.php">
                <img id="imgCar" src="/images/normac4.jpg"  alt="..."
                style="
                width: AUTO;
                height: 360px;
                border-radius: 4px;
                ...
                <div class="carousel-caption ">
                  ...
                  width: 100%;
                  overflow:hidden;
                  ">Absorve construction regulations</p>
                </div>
                </a>
              </div>
