...
<img id="backG" />
  ...
  <section  class="hero-section">
    ...
    <hr>
        ...
        <br>
        <a id="fPass" onclick="forPass();" class="link-dark link-underline-opacity-65 link-underline-opacity-25-hover link-opacity-25-hover link-offset-3">Did you forgot your password?</a>
